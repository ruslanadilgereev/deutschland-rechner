...
{/* Einkünfte */}
      ...
      <aside className="-mt-2 mb-3 text-center">
        ...
        <a
          href="https://a.partner-versicherung.de/click.php?partner_id=201880&ad_id=857&deep=rentenversicherung&tracking=einkommensteuerRentenversInline"
          target="_blank"
        ...
        >
          <img
            ...
            width={728}
            height={90}
            alt="Private Rentenversicherung-Vergleich · Tarifcheck"
            loading="lazy"
