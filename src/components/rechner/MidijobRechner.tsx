...
export default function MidijobRechner() {
  ...
  const ergebnis = useMemo(() => {
    ...
    const durchschnittsentgelt2026 = 51944; // Vorläufiges Durchschnittsentgelt 2026 (§ 1 Abs. 2 SVBezGrV 2026)
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6 mb-6">
        ...
        <div className="space-y-3 text-sm text-blue-700">
          ...
          <p className="text-xs text-blue-600">
            Berechnung: ({formatEuro(bruttolohn)} × 12) ÷ 51.944€ = {ergebnis.rentenpunkteJahr.toFixed(3)} Punkte × 42,52€ Rentenwert
          </p>
        </div>
      </div>
