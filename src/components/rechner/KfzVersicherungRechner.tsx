...
{/* Wichtiger Hinweis */}
      ...
      <aside className="-mt-2 mb-3 text-center">
        ...
        <a
          href="https://a.partner-versicherung.de/click.php?partner_id=201880&ad_id=1634&deep=kfz-versicherung&tracking=versicherungAutoKfzInline"
          target="_blank"
          rel="nofollow sponsored noopener noreferrer"
          className="inline-block max-w-full"
        >
          <img
            src="https://a.partner-versicherung.de/view.php?partner_id=201880&ad_id=1634"
            width={728}
            height={90}
            alt="KFZ-Versicherung-Vergleich · Tarifcheck"
            loading="lazy"
