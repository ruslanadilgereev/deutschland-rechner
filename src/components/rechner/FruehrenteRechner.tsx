...
{/* Input Section */}
      ...
      <aside className="-mt-2 mb-3 text-center">
        ...
        <a href="https://a.partner-versicherung.de/click.php?partner_id=201880&ad_id=591&deep=berufsunfaehigkeitsversicherung&tracking=fruehrenteBuInline" target="_blank" rel="nofollow sponsored noopener noreferrer" className="inline-block max-w-full">
