      ...
      {ergebnis && (
        <>
          ...
          <aside className="-mt-2 mb-3 text-center">
            ...
            <a href="https://a.check24.net/misc/click.php?pid=1171454&aid=317&deep=gasanbieter-wechseln&cat=3&tid=nebenkostenGasInline" target="_blank" rel="nofollow sponsored noopener noreferrer" className="inline-block max-w-full">
              <img src="https://a.check24.net/misc/view.php?pid=1171454&aid=317&cat=3" width={728} height={90} alt="Gas-Anbieter wechseln · CHECK24" loading="lazy" className="max-w-full h-auto block mx-auto" />
            </a>
          </aside>
