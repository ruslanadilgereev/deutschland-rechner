      ...
      {berechnet && ergebnis && (
        <>
          ...
          <aside className="-mt-2 mb-3 text-center">
            ...
            <a
              href="https://a.partner-versicherung.de/click.php?partner_id=201880&ad_id=883&deep=risikolebensversicherung&tracking=lebenserwartungRisikolebenInline"
              target="_blank"
              rel="nofollow sponsored noopener noreferrer"
              className="inline-block max-w-full"
            >
              <img
                src="https://a.partner-versicherung.de/view.php?partner_id=201880&ad_id=883"
                width={728}
                height={90}
                alt="Risikolebensversicherung-Vergleich · Tarifcheck"
                loading="lazy"
