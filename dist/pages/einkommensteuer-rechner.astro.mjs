...
function EinkommensteuerRechner() {
  ...
  const ergebnis = useMemo(() => {
    ...
    if (pendlerKm > 0 && pendlerTage > 0) {
      ...
      pendlerpauschale = (km20 * PAUSCHBETRAEGE.entfernungspauschale.bis20km + kmUeber20 * PAUSCHBETRAEGE.entfernungspauschale.ab21km) * pendlerTage;
    }
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-lg p-6 mb-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
        ...
        pendlerKm > 0 && /* @__PURE__ */ jsxs("p", { className: "text-sm text-green-600 bg-green-50 p-2 rounded-lg", children: [
          ...
          pendlerKm > 20 && /* @__PURE__ */ jsx("span", { className: "block text-xs mt-1", children: "Ab 21 km: 0,38 €/km (erhöht)" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxs("ul", { className: "space-y-2 text-sm text-gray-600", children: [
        ...
        /* @__PURE__ */ jsxs("li", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("span", { children: [
            ...
            /* @__PURE__ */ jsx("strong", { children: "9.600 €/Kind" }),
            " (6.672 € + 2.928 € BEA)"
          ] })
        ] }),
        /* @__PURE__ */ jsxs("li", { className: "flex gap-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
        ...
        /* @__PURE__ */ jsx(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className: "block text-sm text-blue-600 hover:underline",
            children: "Bundesministerium der Finanzen – Steuern"
          }
        ),
        /* @__PURE__ */ jsx(
          "a",
...
const $$EinkommensteuerRechner = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Einkommensteuer-Rechner 2026 \u2013 Steuerlast berechnen", "description": "Einkommensteuer-Rechner 2026: Berechne deine Steuerlast nach \xA732a EStG. Mit Grundfreibetrag 12.348\u20AC, Splittingtarif, Kinderfreibetrag, Pendlerpauschale, Homeoffice-Pauschale. G\xFCnstigerpr\xFCfung Kindergeld inklusive.", "keywords": "Einkommensteuer Rechner 2026, Steuerrechner, Einkommensteuer berechnen, Steuerlast, zvE berechnen, Grundfreibetrag 2026, Splittingtarif, Kinderfreibetrag, Grenzsteuersatz, Durchschnittssteuersatz, Pendlerpauschale, Homeoffice-Pauschale, Werbungskosten, Sonderausgaben" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="min-h-screen pb-8"> <!-- Header mit Zurück-Button --> <header class="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-6 px-4"> <div class="max-w-2xl mx-auto"> <a href="/" class="inline-flex items-center gap-2 text-blue-200 hover:text-white mb-4 transition-colors"> <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path> </svg>
Alle Rechner
