...
const PAUSCHALE_2025 = {
  km_1_20: 0.3,
  // 30 Cent für die ersten 20 km
  km_ab_21: 0.38,
  // 38 Cent ab dem 21. km
  arbeitstage_max: 230
  ...
  return /* @__PURE__ */ jsxs("div", { className: "max-w-2xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-lg p-6 mb-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-3 text-sm", children: [
        entfernung <= 20 ? /* @__PURE__ */ jsxs("div", { className: "flex justify-between py-2 border-b border-gray-100", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between py-2 border-b border-gray-100", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "font-medium", children: formatEuro(20 * 0.3 * ergebnis.effektiveArbeitstage) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between py-2 border-b border-gray-100", children: [
            /* @__PURE__ */ jsxs("span", { className: "text-gray-600", children: [
              "Ab 21. km: ",
            ...
            /* @__PURE__ */ jsx("span", { className: "font-medium", children: formatEuro((entfernung - 20) * 0.38 * ergebnis.effektiveArbeitstage) })
          ] })
        ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-lg p-6 mb-6", children: [
      ...
      /* @__PURE__ */ jsxs("ul", { className: "space-y-2 text-sm text-gray-600", children: [
        /* @__PURE__ */ jsxs("li", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "30 Cent/km" }),
        ...
        /* @__PURE__ */ jsxs("li", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsx("span", { children: "✓" }),
          /* @__PURE__ */ jsxs("span", { children: [
            /* @__PURE__ */ jsx("strong", { children: "38 Cent/km" }),
            " ab dem 21. Kilometer (2025)"
          ] })
        ] }),
        /* @__PURE__ */ jsxs("li", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsx("span", { children: "✓" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
        /* @__PURE__ */ jsx(
          "a",
          {
            ...
            children: "Bundesfinanzministerium – Entfernungspauschale"
          }
        ),
        /* @__PURE__ */ jsx(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className: "block text-sm text-blue-600 hover:underline",
            children: "VLH – Pendlerpauschale 2025"
          }
        )
      ] })
    ] })
...
const $$PendlerpauschaleRechner = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Pendlerpauschale-Rechner 2025", "description": "Berechne deine Pendlerpauschale 2025. Mit 38 Cent ab dem 21. km und Homeoffice-Abzug." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="min-h-screen pb-8"> <!-- Header mit Zurück-Button --> <header class="bg-gradient-to-r from-blue-500 to-indigo-600 text-white py-6 px-4"> <div class="max-w-2xl mx-auto"> <a href="/" class="inline-flex items-center gap-2 text-blue-100 hover:text-white mb-4 transition-colors"> <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path> </svg>
Alle Rechner
</a> <div class="flex items-center gap-3"> <span class="text-4xl">🚗</span> <div> <h1 class="text-2xl font-bold">Pendlerpauschale-Rechner</h1> <p class="text-blue-100 text-sm">Entfernungspauschale 2025</p> </div> </div> </div> </header> <!-- Calculator --> <div class="max-w-2xl mx-auto px-4 py-6"> ${renderComponent($$result2, "PendlerpauschaleRechner", PendlerpauschaleRechner, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/home/ubuntu/clawd/deutschlandrechner/src/components/rechner/PendlerpauschaleRechner", "client:component-export": "default" })} </div> </main> ` })}`;
