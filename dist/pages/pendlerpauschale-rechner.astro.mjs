    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-lg p-6 mb-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-3 text-sm text-gray-600", children: [
        /* @__PURE__ */ jsxs("p", { children: [
          "Die Pendlerpauschale gibst du in der ",
          /* @__PURE__ */ jsx("strong", { children: "Steuererklärung" }),
          " an – genauer in der ",
          /* @__PURE__ */ jsx("strong", { children: "Anlage N" }),
          " (Werbungskosten)."
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex gap-3 p-3 bg-blue-50 rounded-xl", children: [
          /* @__PURE__ */ jsx("span", { className: "text-xl", children: "📋" }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "font-medium text-blue-800", children: "Finanzamt" }),
            /* @__PURE__ */ jsx("p", { className: "text-blue-700", children: "Dein zuständiges Finanzamt bearbeitet deine Steuererklärung. Du erreichst es am einfachsten über ELSTER." }),
            /* @__PURE__ */ jsx(
              "a",
              {
                ...
                children: "→ www.elster.de (Online-Steuererklärung)"
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500", children: "Tipp: Viele Steuersoftware-Programme (z.B. WISO Steuer, Tax) berechnen die Pendlerpauschale automatisch." })
      ] })
    ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
        ...
        /* @__PURE__ */ jsx(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className: "block text-sm text-blue-600 hover:underline",
            children: "VLH – Fünf Steueränderungen 2026 (inkl. Pendlerpauschale)"
          }
        )
      ] })
    ] })
