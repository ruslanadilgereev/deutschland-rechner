...
function berechneKindRegelsatz(alter) {
  switch (alter) {
    case "klein":
      return REGELSAETZE_2025.kind_0_5;
    case "mittel":
      return REGELSAETZE_2025.kind_6_13;
    case "gross":
      return REGELSAETZE_2025.kind_14_17;
  }
}
          ...
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "text-xs mt-1 opacity-80", children: formatEuro(REGELSAETZE_2025.alleinstehend) })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "text-xs mt-1 opacity-80", children: [
                  "je ",
                  formatEuro(REGELSAETZE_2025.partner)
                ] })
              ]
            }
          )
          ...
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500", children: formatEuro(REGELSAETZE_2025.kind_0_5) })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500", children: formatEuro(REGELSAETZE_2025.kind_6_13) })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500", children: formatEuro(REGELSAETZE_2025.kind_14_17) })
              ]
            }
          )
        ] })
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
        ...
        /* @__PURE__ */ jsx(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className: "block text-sm text-blue-600 hover:underline",
            children: "BMAS – Bürgergeld-Gesetz"
          }
        )
      ] })
    ] })
...
const $$BuergergeldRechner = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "B\xFCrgergeld-Rechner 2025", "description": "Berechne deinen B\xFCrgergeld-Anspruch 2025. Mit Regels\xE4tzen, Freibetr\xE4gen und Kosten der Unterkunft." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="min-h-screen pb-8"> <!-- Header mit Zurück-Button --> <header class="bg-gradient-to-r from-green-500 to-teal-600 text-white py-6 px-4"> <div class="max-w-2xl mx-auto"> <a href="/" class="inline-flex items-center gap-2 text-green-100 hover:text-white mb-4 transition-colors"> <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path> </svg>
Alle Rechner
</a> <div class="flex items-center gap-3"> <span class="text-4xl">🏦</span> <div> <h1 class="text-2xl font-bold">Bürgergeld-Rechner</h1> <p class="text-green-100 text-sm">Regelsätze 2025</p> </div> </div> </div> </header> <!-- Calculator --> <div class="max-w-2xl mx-auto px-4 py-6"> ${renderComponent($$result2, "BuergergeldRechner", BuergergeldRechner, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/home/ubuntu/clawd/deutschlandrechner/src/components/rechner/BuergergeldRechner", "client:component-export": "default" })} </div> </main> ` })}`;
