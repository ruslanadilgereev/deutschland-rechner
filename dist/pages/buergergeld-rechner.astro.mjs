...
function BuergergeldRechner() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "max-w-2xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6", children: [
      /* @__PURE__ */ jsx("h4", { className: "font-bold text-blue-800 mb-2", children: "➕ Mehrbedarf (nicht im Rechner enthalten)" }),
      /* @__PURE__ */ jsxs("ul", { className: "text-sm text-blue-700 space-y-1", children: [
        /* @__PURE__ */ jsxs("li", { children: [
          "• ",
          /* @__PURE__ */ jsx("strong", { children: "Alleinerziehende:" }),
          " +12% bis +60% je nach Kinderzahl/Alter"
        ] }),
        /* @__PURE__ */ jsxs("li", { children: [
          "• ",
          /* @__PURE__ */ jsx("strong", { children: "Schwangere:" }),
          " +17% ab 13. Schwangerschaftswoche"
        ] }),
        /* @__PURE__ */ jsxs("li", { children: [
          "• ",
          /* @__PURE__ */ jsx("strong", { children: "Menschen mit Behinderung:" }),
          " +17-35% je nach Merkzeichen"
        ] }),
        /* @__PURE__ */ jsxs("li", { children: [
          "• ",
          /* @__PURE__ */ jsx("strong", { children: "Kranke:" }),
          " Mehrbedarf für kostenaufwändige Ernährung möglich"
        ] })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "text-xs text-blue-600 mt-2", children: "Diese Mehrbedarfe werden zusätzlich zum Regelbedarf gewährt (§ 21 SGB II)." })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6", children: [
      /* @__PURE__ */ jsx("h4", { className: "font-bold text-amber-800 mb-2", children: '📢 Änderungen ab 1. Juli 2026: „Grundsicherungsgeld"' }),
      /* @__PURE__ */ jsxs("div", { className: "text-sm text-amber-700 space-y-2", children: [
        /* @__PURE__ */ jsxs("p", { children: [
          "Das Bürgergeld wird zum ",
          /* @__PURE__ */ jsx("strong", { children: '„Grundsicherungsgeld"' }),
          " umbenannt. Wichtige Neuerungen:"
        ] }),
        /* @__PURE__ */ jsxs("ul", { className: "list-disc pl-5 space-y-1", children: [
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Vermittlungsvorrang:" }),
            " Arbeitsvermittlung hat Priorität vor Weiterbildung"
          ] }),
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Vermögen:" }),
            " Karenzzeit wird abgeschafft, Freibeträge werden altersabhängig"
          ] }),
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Sanktionen verschärft:" }),
            " Bis zu 30% Kürzung bei Pflichtverletzung"
          ] }),
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Wohnkosten:" }),
            " Deckelung schon in Karenzzeit (1,5× Angemessenheitsgrenze)"
          ] }),
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Alleinerziehende:" }),
            " Ab 1 Jahr (statt 3 Jahre) für Arbeit heranziehbar"
          ] })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-xs mt-2", children: "Quelle: Bundeskabinett-Beschluss vom 17.12.2025, Bundestag berät aktuell" })
      ] })
    ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
        ...
        /* @__PURE__ */ jsx(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className: "block text-sm text-blue-600 hover:underline",
            children: "Finanztip – Bürgergeld 2026 & Grundsicherungsgeld"
          }
        ),
        /* @__PURE__ */ jsx(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className: "block text-sm text-blue-600 hover:underline",
            children: "Bundesregierung – Neue Grundsicherung (Kabinettsbeschluss)"
          }
        )
      ] })
    ] })
...
const $$BuergergeldRechner = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "B\xFCrgergeld-Rechner 2026 \u2013 Regels\xE4tze, Freibetr\xE4ge & KdU berechnen | Ab Juli: Grundsicherungsgeld", "description": "Berechne deinen B\xFCrgergeld-Anspruch 2026. Mit aktuellen Regels\xE4tzen (563\u20AC Alleinstehend, 506\u20AC Partner), Freibetr\xE4gen und Kosten der Unterkunft. Inkl. Info zur Reform ab Juli 2026." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="min-h-screen pb-8"> <!-- Header mit Zurück-Button --> <header class="bg-gradient-to-r from-green-500 to-teal-600 text-white py-6 px-4"> <div class="max-w-2xl mx-auto"> <a href="/" class="inline-flex items-center gap-2 text-green-100 hover:text-white mb-4 transition-colors"> <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path> </svg>
Alle Rechner
