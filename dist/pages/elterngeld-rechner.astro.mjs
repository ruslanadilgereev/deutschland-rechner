...
function berechneElterngeld(nettoMonat) {
  ...
  if (nettoMonat < 1200) {
    ...
    ersatzrate = 0.67 - (nettoMonat - 1200) * 1e-3;
  }
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-lg p-6 mb-6", children: [
      ...
      /* @__PURE__ */ jsxs("ul", { className: "space-y-2 text-sm text-gray-600", children: [
        ...
        /* @__PURE__ */ jsxs("li", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("span", { children: [
            "Einkommensgrenze: ",
            /* @__PURE__ */ jsx("strong", { children: "200.000 € (Paar)" }),
            " / 150.000 € (Alleinerziehend)"
          ] })
        ] })
      ] })
    ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 p-3 bg-gray-50 rounded-xl", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 mt-1", children: "In vielen Bundesländern verfügbar" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 p-3 bg-gray-50 rounded-xl", children: [
            /* @__PURE__ */ jsx("span", { className: "text-xl", children: "📞" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
        ...
        /* @__PURE__ */ jsx(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className: "block text-sm text-blue-600 hover:underline",
            children: "BMFSFJ – Elterngeld & ElterngeldPlus"
          }
        )
      ] })
    ] })
...
const $$ElterngeldRechner = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Elterngeld-Rechner 2025", "description": "Berechne dein Elterngeld 2025. Basiselterngeld oder ElterngeldPlus \u2013 mit Vergleich und allen Infos." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="min-h-screen pb-8"> <!-- Header mit Zurück-Button --> <header class="bg-gradient-to-r from-pink-500 to-rose-600 text-white py-6 px-4"> <div class="max-w-2xl mx-auto"> <a href="/" class="inline-flex items-center gap-2 text-pink-100 hover:text-white mb-4 transition-colors"> <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path> </svg>
Alle Rechner
</a> <div class="flex items-center gap-3"> <span class="text-4xl">🍼</span> <div> <h1 class="text-2xl font-bold">Elterngeld-Rechner</h1> <p class="text-pink-100 text-sm">Basis & Plus – Stand 2025</p> </div> </div> </div> </header> <!-- Calculator --> <div class="max-w-2xl mx-auto px-4 py-6"> ${renderComponent($$result2, "ElterngeldRechner", ElterngeldRechner, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/home/ubuntu/clawd/deutschlandrechner/src/components/rechner/ElterngeldRechner", "client:component-export": "default" })} </div> </main> ` })}`;
