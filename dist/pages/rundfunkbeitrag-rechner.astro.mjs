...
const BEITRAG = {
  standard: 18.36,
  // € pro Monat (seit Januar 2024, unverändert bis mind. Ende 2026)
  ermaessigt: 6.12,
  // € pro Monat für Ermäßigungsberechtigte (RF-Merkzeichen)
  quartal: 55.08};
...
function RundfunkbeitragRechner() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "max-w-2xl mx-auto", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-blue-50 border border-blue-200 rounded-2xl p-6 mb-6", children: [
      /* @__PURE__ */ jsx("h3", { className: "font-bold text-blue-800 mb-3", children: "⚖️ Aktuell: Rundfunkbeitrag vor dem Bundesverfassungsgericht" }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-2 text-sm text-blue-700", children: [
        /* @__PURE__ */ jsxs("p", { children: [
          /* @__PURE__ */ jsx("strong", { children: "Stand 2026:" }),
          " Der Rundfunkbeitrag bleibt bei ",
          /* @__PURE__ */ jsxs("strong", { children: [
            formatEuro(BEITRAG.standard),
            "/Monat"
          ] }),
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          /* @__PURE__ */ jsx("strong", { children: "Verfassungsbeschwerde:" }),
          " ARD und ZDF haben im November 2024 Verfassungsbeschwerde eingereicht (Az. 1 BvR 2524/24). Das Bundesverfassungsgericht wird voraussichtlich 2026 entscheiden."
        ] }),
        /* @__PURE__ */ jsxs("p", { children: [
          /* @__PURE__ */ jsx("strong", { children: "Ausblick:" }),
          " Die KEF schlägt für 2027 einen Beitrag von 18,64€ vor (25. KEF-Bericht wird Ende Februar 2026 erwartet)."
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-lg p-6 mb-6", children: [
      ...
      /* @__PURE__ */ jsxs("ul", { className: "space-y-2 text-sm text-gray-600", children: [
        ...
        /* @__PURE__ */ jsxs("li", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("span", { children: [
            ...
            " pro Quartal) – unverändert seit Januar 2024"
          ] })
        ] }),
        /* @__PURE__ */ jsxs("li", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsx("span", { children: "✓" }),
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("ul", { className: "text-gray-600 mt-1 space-y-1", children: [
                /* @__PURE__ */ jsxs("li", { children: [
                  "• ",
                  /* @__PURE__ */ jsx("a", { href: "https://www.rundfunkbeitrag.de/buergerinnen-und-buerger/formulare/anmelden", target: "_blank", rel: "noopener noreferrer", className: "text-blue-600 hover:underline", children: "Anmelden" })
                ] }),
                /* @__PURE__ */ jsxs("li", { children: [
                  "• ",
                  /* @__PURE__ */ jsx("a", { href: "https://www.rundfunkbeitrag.de/buergerinnen-und-buerger/formulare/abmelden", target: "_blank", rel: "noopener noreferrer", className: "text-blue-600 hover:underline", children: "Abmelden" })
                ] }),
                /* @__PURE__ */ jsxs("li", { children: [
                  "• ",
                  /* @__PURE__ */ jsx("a", { href: "https://www.rundfunkbeitrag.de/buergerinnen-und-buerger/formulare/befreiung-oder-ermaessigung-beantragen", target: "_blank", rel: "noopener noreferrer", className: "text-blue-600 hover:underline", children: "Befreiung beantragen" })
                ] })
              ] })
            ] })
          ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
        ...
        /* @__PURE__ */ jsx(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className: "block text-sm text-blue-600 hover:underline",
            children: "Finanztip – Rundfunkbeitrag 2025/2026 erklärt"
          }
        ),
        /* @__PURE__ */ jsx(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className: "block text-sm text-blue-600 hover:underline",
            children: "Verbraucherzentrale – Befreiung und Ermäßigung"
          }
        )
      ] })
    ] })
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Der Rundfunkbeitrag betr\xE4gt 18,36 \u20AC pro Monat (55,08 \u20AC pro Quartal, 220,32 \u20AC pro Jahr). Die geplante Erh\xF6hung auf 18,94 \u20AC wurde von den Bundesl\xE4ndern abgelehnt. Bei Erm\xE4\xDFigung (RF-Merkzeichen) sind es nur 6,12 \u20AC pro Monat."
        }
      },
      {
        "@type": "Question",
        "name": "Steigt der Rundfunkbeitrag 2026 oder 2027?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Der Beitrag bleibt 2026 bei 18,36 \u20AC. ARD und ZDF haben Verfassungsbeschwerde eingelegt (1 BvR 2524/24), da die L\xE4nder die Erh\xF6hung blockieren. Die KEF schl\xE4gt f\xFCr 2027 einen Beitrag von 18,64 \u20AC vor."
        }
      },
      {
        "@type": "Question",
