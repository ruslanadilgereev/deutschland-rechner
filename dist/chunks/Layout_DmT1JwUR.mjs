import { b as createAstro, c as createComponent, a as renderTemplate, d as renderSlot, e as renderHead, u as unescapeHTML, f as addAttribute } from './astro/server_Bf3RW9Fp.mjs';
import 'piccolore';
import 'clsx';
/* empty css                                     */
...
var _a;
const $$Astro = createAstro("https://www.deutschland-rechner.de");
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Layout;
  const {
    title,
    description = "Alle deutschen Rechner auf einen Blick. Kindergeld, B\xFCrgergeld, Brutto-Netto und mehr \u2013 kostenlos und aktuell f\xFCr 2026.",
    keywords = "Rechner, Deutschland, Kindergeld, B\xFCrgergeld, Brutto Netto, Elterngeld, Steuer, 2026",
    canonical,
    ogImage = "/og-default.png"
  } = Astro2.props;
  const siteUrl = "https://www.deutschland-rechner.de";
  const fullTitle = title === "Alle Rechner" ? "Deutschlandrechner \u2013 Alle deutschen Rechner 2026" : `${title} | Deutschlandrechner`;
