...
- [Astro 5](https://astro.build) - Statische Seitengenerierung
- [React 19](https://react.dev) - Interaktive Rechner-Komponenten
...
3. **Code beitragen?** - Siehe [CONTRIBUTING.md](CONTRIBUTING.md)
